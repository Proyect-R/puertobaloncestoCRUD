...
$r->addRoute('GET', '/entrenadores/{id:\d+}/editar', ['App\Controlador\EntrenadorController', 'actualizarEntrenador']);
$r->addRoute('POST', '/entrenadores/editar', ['App\Controlador\EntrenadorController', 'enviarActualizado']);
});
